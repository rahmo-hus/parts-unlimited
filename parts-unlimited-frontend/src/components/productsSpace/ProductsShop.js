            ...
            <div className="wrap-body-inner" style={{minHeight: '1200px'}}>
                ...
                <section className="m-t-lg-30 m-t-xs-0">
                        <div className="row">
                            ...
                            <Routes>
                                    <Route exact path="/products" element={<ProductsContainer productsCategory={this.state.activePage} productsList={this.props.products}/>} />
                                    <Route exact path="/products/singleproduct" element={<ProductDetails/>} />
                            </Routes>
